...
# @app.put("/user/{skill_id}", response_model=User, status_code = status.HTTP_200_OK)
...
# @app.get("/itemskills", response_model=List[itemSkill], status_code=200)
# def get_all_itemskills():
#     items= db.query(models.itemSkill).all()
#     return items

# @app.get("/itemskill/{skill_id}")
# def get_an_skill(skill_id:int):
#     skill= db.query(models.itemSkill).filter(models.itemSkill.id == skill_id).first()
#     return skill

# @app.post("/itemskills",response_model = itemSkill, status_code= status.HTTP_201_CREATED)
...
# @app.put("/itemskill/{skill_id}", response_model=itemSkill, status_code = status.HTTP_200_OK)
